...
def cleaning_flight_data(spark):
    ...
    .load("s3://777-termproject/csv/flights_2019_full.csv")
    ...
    df.select("features", "DEP_DEL15").write.mode("overwrite").parquet(
        "s3://777-termproject/processed/flights_2019_cleaned/"
    )
...
def feature_eng():
    ...
    origin_indexer = StringIndexer(inputCol="ORIGIN_AIRPORT_ID", outputCol="origin_index")
    dest_indexer = StringIndexer(inputCol="DEST_AIRPORT_ID", outputCol="dest_index")
